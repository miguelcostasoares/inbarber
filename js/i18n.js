...
(function () {
  ...
  var DICT = {
    ...
    pt: {
      ...
      'team.tag'   : 'Quem vai cortar',
      'team.h'     : 'A mão por trás<br>do <em>corte.</em>',
      'team.sub'   : 'Numa barbearia escolhe-se a pessoa antes do serviço. Marque com quem já o conhece.',
      ...
      'rev.verified' : 'Avaliação verificada no Google',
    ...
    en: {
      ...
      'team.tag'   : 'Who cuts',
      'team.h'     : 'The hands behind<br>the <em>cut.</em>',
      'team.sub'   : 'At a barbershop you pick the person before the service. Book with someone who already knows you.',
      'team.cta'   : 'Book with',
      ...
      'rev.verified' : 'Verified Google review',
      'rev.stars'    : '5 stars',
    ...
    es: {
      ...
      'team.tag'   : 'Quién corta',
      'team.h'     : 'La mano detrás<br>del <em>corte.</em>',
      'team.sub'   : 'En una barbería se elige a la persona antes que el servicio. Reserva con quien ya te conoce.',
      ...
      'rev.verified' : 'Valoración verificada en Google',
